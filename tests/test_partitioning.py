...
class TestCircuitPartitioning:
    ...
    def test_solver_integration(self):
        ...
        with patch("quantum_portfolio_optimizer.core.vqe_solver.run_partitioned_vqe_step") as mock_part:
            ...
            solver.optimizer_config = DifferentialEvolutionConfig(bounds=[(0,1)]*4, maxiter=1, popsize=1)
